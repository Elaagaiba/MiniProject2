...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnPass;
    TextView tvQuote,tvAuthor,tvId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FavQuotesOpenHelperDb db = new FavQuotesOpenHelperDb(this);
        ...
        ivFavorite.setOnClickListener(v-> {
            ...
            if(isFavorite) {
                ...
                String quotes = tvQuote.getText().toString();
                String author = tvAuthor.getText().toString();
                db.add(new Quote(id,quotes,author));
        ...
        quotes = db.getAll();
        for (Quote quoteDb: quotes){
            Log.i("DbQuote", quoteDb.toString());
        }
    ...
    private void getRandomQuotes() {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            tvId.setText(String.format("#%s",jsonObject.getString("id")));
        ...
        //                try {
        //                    tvId.setText(String.format("#%d",response.getInt("id")));
        //                    tvQuote.setText(response.getString("quote"));
